...
public class TicTacToe implements ActionListener {
    ...
    JButton[] buttons = new JButton[9]; //We need 9 buttons only
    boolean player1_turn; //If it is false, it will be player 2's turn
    TicTacToe(){
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        frame.setSize(500, 500);
        frame.getContentPane().setBackground(new Color(50, 50, 50)); //red green black
